...
import 'package:tubes_uas_final/screens/maps/dago_map.dart';
import 'package:tubes_uas_final/screens/video_screens/dago_video_screen.dart';
...
class WisataDagoScreen extends StatefulWidget {
  const WisataDagoScreen({Key? key}) : super(key: key);

  @override
  State<WisataDagoScreen> createState() => _WisataDagoScreenState();
}

class _WisataDagoScreenState extends State<WisataDagoScreen> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.fill,
                  image: NetworkImage('https://images.unsplash.com/photo-1642229320334-8efe5fb3594a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1073&q=80',),
                ),
              ),
            ),
            ...
            Container(
              ...
              child: const Text("Dago", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30.0, color: Colors.black), textAlign: TextAlign.center,),
            ),
            ...
            Container(
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context)=> const DagoMap()),
                  );
                },
                child: const Center(
                ...
                children: [
                  ...
                  Column(
                    children: const [
                      ...
                      SizedBox(height: 8.0),
                      Text("60 min", style: TextStyle(color: Colors.black),),
                    ],
                  ),
                  Column(
                    children: const [
            ...
            Container(
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const DagoVideoScreen()),
                  );
                },
                child: const Center(
